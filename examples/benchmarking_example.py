...
def run_example():
    ...
    for sample_count in sample_counts:
        ...
        benchmark_prediction = pred.predict(state_estimator.x, future_loading, n_samples = sample_count)
        toe = benchmark_prediction.time_of_event.key("EOD")  # Looking at EOD event
